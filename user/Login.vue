    ...
    <app-content-section>
      <div class="content-wrapper">
        <div class="row row-centered">
          <div
            class="col col-tablet-portrait-10 col-large-5 col-large-after-1 col-xlarge-4 col-xlarge-after-2 col-wrapping col-large-no-bottom-margin"
          >
          ...
          <div
            class="col col-tablet-portrait-10 col-large-5 col-xlarge-4 col-wrapping col-no-bottom-margin"
          >
